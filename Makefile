...
cversion_debug: lasso.cpp logreg.cpp common.h mmio.c mmio.h read_matrix_market.cpp mm_lasso.cpp write_matrix_market.cpp shared.cpp
	$(CPP) -g  -Wall -pthread -Xpreprocessor -fopenmp lasso.cpp logreg.cpp read_matrix_market.cpp mmio.c mm_lasso.cpp write_matrix_market.cpp shared.cpp -o mm_lasso -lomp
...
cversion_release: lasso.cpp logreg.cpp common.h mmio.c mmio.h read_matrix_market.cpp mm_lasso.cpp write_matrix_market.cpp shared.cpp
	$(CPP) -Wall -pthread -Xpreprocessor -fopenmp lasso.cpp logreg.cpp read_matrix_market.cpp mmio.c mm_lasso.cpp write_matrix_market.cpp shared.cpp -o mm_lasso -lomp -O3
